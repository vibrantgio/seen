...
func MakeQuatRotX(angle float64) *Quaternion {
	s, c := math.Sincos(angle / 2)
	return &Quaternion{s,0.0,0.0,c}
}

func MakeQuatRotY(angle float64) *Quaternion {
	s, c := math.Sincos(angle / 2)
	return &Quaternion{0.0,s,0.0,c}
}

func MakeQuatRotZ(angle float64) *Quaternion {
	s, c := math.Sincos(angle / 2)
	return &Quaternion{0.0,0.0,s,c}
}

func MakeQuatAxisAngle(x, y, z, angle float64) *Quaternion {
